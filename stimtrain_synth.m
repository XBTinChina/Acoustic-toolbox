function M = stimtrain_synth(SampleRate,F1,F2,D1,D2,Bandwidth,NumComps,...
...
%
%  e.g., stimtrain_synth(44100,1000,1500,200,5,100,50,0,0,0,0,0,0,1)
%
...
NumArgs=nargin('stimtrain_synth');
if nargin ~= NumArgs
    help stimtrain_synth;
	return
end
...
if ShortNames==1
   wavwrite(FM_Train,SampleRate,16,Short_FM_WAVFileName);
else
   wavwrite(FM_Train,SampleRate,16,FM_WAVFileName);
end
   fprintf('\nCreated:  %s\n',Short_FM_WAVFileName);
   fprintf(' in  %s\n\n',WavPath);
